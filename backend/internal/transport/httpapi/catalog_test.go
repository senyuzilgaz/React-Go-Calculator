...
// Copied verbatim from docs/API_EXAMPLES.md. Comparing decoded values rather than bytes
// keeps the test about the contract and not about whitespace.
...
// The schema declares additionalProperties false, so an extra field is a contract break
// even if nothing reads it yet.
